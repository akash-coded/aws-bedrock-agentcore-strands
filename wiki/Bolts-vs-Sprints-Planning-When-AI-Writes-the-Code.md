...
# Bolts vs Sprints: Planning Work When AI Writes the Code
...
<p align="center"><a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/bolts-vs-sprints/"><picture><source media="(prefers-color-scheme: dark)" srcset="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-bolt-days.dark.webp"><img alt="A bolt plan: one risk per bolt, the walking skeleton first" src="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-bolt-days.light.webp" width="100%"></picture></a></p>

<sub>▸ <a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/bolts-vs-sprints/">Open the live, interactive version</a></sub>
...
A bolt that needs a chat thread was cut wrong. [The story file](What-Is-AIDD-AI-Driven-Development#step-2--build-from-a-story-file-not-a-chat-thread)
...
| One unknown per bolt; cut by dependency; exposure in unknown-days | **Original** — this playbook | [How to cut sprints into bolts](How-to-Cut-Sprints-into-Bolts) |
...
| The SkyWays plan | **Illustrative** — a fictional airline | [Try the bolt planner](https://akash-coded.github.io/aws-bedrock-agentcore-strands/simulator/#/toolkit/bolts) |

---

| | |
| :--- | ---: |
| [← How to run an agentic AI project](How-to-Run-an-Agentic-AI-Project) | [A board for agentic work →](How-to-Set-Up-a-Kanban-Board-for-an-Agentic-AI-Project) |

**[All lessons](Start-Here)** · **[Running delivery](Tutorial-Running-Delivery)** · [This lesson on the site](https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/bolts-vs-sprints/)

<sub>✏️ This page is generated from [`site/content/learn/lessons/bolts-vs-sprints.md`](https://github.com/akash-coded/aws-bedrock-agentcore-strands/blob/main/site/content/learn/lessons/bolts-vs-sprints.md). To change it, [edit the lesson](https://github.com/akash-coded/aws-bedrock-agentcore-strands/edit/main/site/content/learn/lessons/bolts-vs-sprints.md) — an edit made here is replaced at the next sync.</sub>
