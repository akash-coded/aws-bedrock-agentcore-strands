...
# Agentic PDLC Exercises: 12 Problems with Worked Answers
...
<p align="center"><a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-pdlc-exercises/"><picture><source media="(prefers-color-scheme: dark)" srcset="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/map-agentic-pdlc-exercises.dark.webp"><img alt="Twelve exercises, three per phase" src="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/map-agentic-pdlc-exercises.light.webp" width="100%"></picture></a></p>

<sub>▸ <a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-pdlc-exercises/">Open the live, interactive version</a></sub>
...
Learn it: [Is it AI work at all?](P0-Frame-Is-an-AI-Agent-Worth-Building#step-2--decide-whether-it-is-ai-at-all)
...
Learn it: [Size the value, net of running and checking it](P0-Frame-Is-an-AI-Agent-Worth-Building#step-3--size-the-value-net-of-running-and-checking-it)
...
Learn it: [The hard gate](The-Hard-Gate-in-Agentic-Delivery)
...
Learn it: [How accurate must an AI agent be?](How-Accurate-Does-an-AI-Agent-Need-to-Be)
...
Learn it: [Chained steps multiply](P2-Build-and-Prove-Build-an-AI-Agent-in-Slices#step-4--put-an-independent-checker-after-the-risky-steps)
...
Learn it: [Decide how many agents](P1-Design-and-Spec-Write-a-Spec-an-Agent-Can-Build#step-5--decide-how-many-agents-and-record-only-the-decisions-that-earn-it)
...
Learn it: [Prove the bar](How-to-Prove-an-AI-Agent-Meets-Its-Bar)
...
Learn it: [Cut over and widen on evidence](Shadow-Mode-and-Canary-Releases-for-AI-Agents#step-4--cut-over-at-5-per-action-and-widen-on-evidence)
...
Learn it: [Review AI-generated code by risk](How-to-Review-AI-Generated-Code-by-Risk)
...
Learn it: [Why the bill is 4×](Why-Your-AI-Agent-Costs-4x-the-Estimate)
...
Learn it: [Two thresholds, not one](AI-Drift-How-to-Catch-the-Defect-With-No-Error-Message#step-3--set-two-thresholds-not-one)
...
Learn it: [AI incident postmortems](Postmortems-for-AI-Incidents-Find-the-Missing-Control)
...
The playbook's wiki has thirty-one more in [Exercises and answers](Exercises-and-Answers), in
...
| The bar, the value line, the four gate questions, fix order | **Original** — this playbook | [Frameworks](https://akash-coded.github.io/aws-bedrock-agentcore-strands/frameworks/) |
...
| | |
| :--- | ---: |
| [← The simulator](Agentic-AI-Delivery-Simulator) | [What is an FDE? →](What-Is-a-Forward-Deployed-Engineer-FDE) |

**[All lessons](Start-Here)** · **[Practice](Tutorial-Practice)** · [This lesson on the site](https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-pdlc-exercises/)

<sub>✏️ This page is generated from [`site/content/learn/lessons/agentic-pdlc-exercises.md`](https://github.com/akash-coded/aws-bedrock-agentcore-strands/blob/main/site/content/learn/lessons/agentic-pdlc-exercises.md). To change it, [edit the lesson](https://github.com/akash-coded/aws-bedrock-agentcore-strands/edit/main/site/content/learn/lessons/agentic-pdlc-exercises.md) — an edit made here is replaced at the next sync.</sub>
