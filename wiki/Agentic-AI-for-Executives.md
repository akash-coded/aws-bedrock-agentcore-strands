...
# Agentic AI for Executives: Four Decisions Only You Can Make
...
controls a team either has or does not. [The maturity model](AI-Delivery-Maturity-Model)
...
[Rolling out agentic delivery](How-to-Roll-Out-Agentic-AI-Delivery)
...
| Idea | Origin | Source |
| --- | --- | --- |
| The four decisions, four questions, seven signals and first thirty days | **Original** — this playbook | [For leadership](https://akash-coded.github.io/aws-bedrock-agentcore-strands/protocol/) · [Role: Sponsor](Role-Sponsor) |
| The six-control maturity check | **Original** — this playbook | [Gates and Governance](Gates-and-Governance#maturity-control-not-tool-count) |
