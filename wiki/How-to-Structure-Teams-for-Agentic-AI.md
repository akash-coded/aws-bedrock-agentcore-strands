...
# How to Structure Teams for Agentic AI: Roles, Pods and Seams
...
[Who signs what](AI-Governance-Gates-That-Dont-Slow-Delivery#who-signs-what)
...
| Idea | Origin | Source |
| --- | --- | --- |
| Five roles, none new; the two boundaries that move | **Original** — this playbook | [For leadership](https://akash-coded.github.io/aws-bedrock-agentcore-strands/protocol/) |
...
| One layer every model call passes through, funded centrally | **Original** — this playbook | [For leadership](https://akash-coded.github.io/aws-bedrock-agentcore-strands/protocol/) |
