...
# Agentic Delivery Cadence: What Runs Daily, Weekly, Quarterly
...
day. **Owners:** engineering lead, architect for the cut. [Bolts vs sprints](Bolts-vs-Sprints-Planning-When-AI-Writes-the-Code)
...
lane with no human reader. **Owners:** QA lead, DevOps, programme manager. [Drift](AI-Drift-How-to-Catch-the-Defect-With-No-Error-Message)
...
manager, sponsor. [Measuring AI productivity](How-to-Measure-AI-Productivity)
...
[The maturity model](AI-Delivery-Maturity-Model)
...
before the event, not after it. [The eight loops](The-8-Feedback-Loops-of-Agentic-Delivery)
...
| Idea | Origin | Source |
| --- | --- | --- |
| The six clocks as one schedule | **Original** — this tutorial, from the playbook's cadences | [Journey: Engineering lead](Journey-Engineering-Lead) |
| The weekly and every-change injection suite; a suite that stops growing | **Original** — this playbook | [Journey: Engineering lead](Journey-Engineering-Lead) |
| Two drift thresholds, with a breach that re-opens the gate | **Original** — this playbook | [Drift](AI-Drift-How-to-Catch-the-Defect-With-No-Error-Message) |
...
| | |
| :--- | ---: |
| [← The SkyWays case study](Agentic-AI-Case-Study-SkyWays) | [The simulator →](Agentic-AI-Delivery-Simulator) |

**[All lessons](Start-Here)** · **[Practice](Tutorial-Practice)** · [This lesson on the site](https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-delivery-cadence/)

<sub>✏️ This page is generated from [`site/content/learn/lessons/agentic-delivery-cadence.md`](https://github.com/akash-coded/aws-bedrock-agentcore-strands/blob/main/site/content/learn/lessons/agentic-delivery-cadence.md). To change it, [edit the lesson](https://github.com/akash-coded/aws-bedrock-agentcore-strands/edit/main/site/content/learn/lessons/agentic-delivery-cadence.md) — an edit made here is replaced at the next sync.</sub>
