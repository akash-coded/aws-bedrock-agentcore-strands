...
# The Agentic PDLC for Business Sponsors: Ask for Two Numbers
...
<p align="center"><a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-pdlc-for-business-sponsors/"><picture><source media="(prefers-color-scheme: dark)" srcset="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-two-numbers.dark.webp"><img alt="The two numbers a sponsor reports together: the saving and the spend" src="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-two-numbers.light.webp" width="100%"></picture></a></p>

<sub>▸ <a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-pdlc-for-business-sponsors/">Open the live, interactive version</a></sub>
...
freeze stops the work and teaches nothing. [Why the bill is 4×](Why-Your-AI-Agent-Costs-4x-the-Estimate)
...
a reminder or a prompt edit as the answer. [AI incident postmortems](Postmortems-for-AI-Incidents-Find-the-Missing-Control)
...
| Idea | Origin | Source |
| --- | --- | --- |
| The sponsor's owns, shapes and must-not-touch; the three reports | **Original** — this playbook | [Role: Sponsor](Role-Sponsor) |
| The four questions and the two-number report | **Original** — this playbook | [For leadership](https://akash-coded.github.io/aws-bedrock-agentcore-strands/protocol/) |
