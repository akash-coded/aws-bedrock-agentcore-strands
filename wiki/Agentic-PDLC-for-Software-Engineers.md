...
# The Agentic PDLC for Software Engineers: Build With Agents
...
**6 min read** · Beginner · Lesson 4 of 9 in [By role](Tutorial-By-Role) · Updated 24 Sep 2026 · [Read it on the site, with live diagrams ↗](https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-pdlc-for-engineers/)
...
<p align="center"><a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-pdlc-for-engineers/"><picture><source media="(prefers-color-scheme: dark)" srcset="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/map-agentic-pdlc-for-engineers.dark.webp"><img alt="The engineer's eight steps across the four phases, six of them in P2" src="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/map-agentic-pdlc-for-engineers.light.webp" width="100%"></picture></a></p>

<sub>▸ <a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-pdlc-for-engineers/">Open the live, interactive version</a></sub>
...
you have. [AIDD's five habits](What-Is-AIDD-AI-Driven-Development)
...
from. [Why the bill is 4×](Why-Your-AI-Agent-Costs-4x-the-Estimate)
...
| Idea | Origin | Source |
| --- | --- | --- |
| The engineering lead's eight steps, owns and not-yours | **Original** — this playbook | [Engineering lead, end to end](https://akash-coded.github.io/aws-bedrock-agentcore-strands/engineering/) · [Role: Engineering lead](Role-Engineering-Lead) |
| The shift: stop treating a prompt rule as a control | **Original** — this playbook | [For leadership](https://akash-coded.github.io/aws-bedrock-agentcore-strands/protocol/) |
| The walking skeleton | **Borrowed** | Cockburn, A. (2004). *Crystal Clear*. Addison-Wesley |
| The SkyWays examples | **Illustrative** — a fictional airline | [Journey: Engineering lead](Journey-Engineering-Lead) |
