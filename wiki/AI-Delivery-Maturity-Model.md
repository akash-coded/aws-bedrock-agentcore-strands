...
# AI Maturity Model: Six Controls You Can Test in Ten Minutes
...
ten minutes. [Run the self-check](https://akash-coded.github.io/aws-bedrock-agentcore-strands/simulator/#/toolkit/maturity)
...
| Idea | Origin | Source |
| --- | --- | --- |
| Six controls, each with a test; the level is the count | **Original** — this playbook | [Maturity: control, not tool count](Gates-and-Governance#maturity-control-not-tool-count) |
| Read the list, not the number; build the first missing control | **Original** — this playbook | [For leadership](https://akash-coded.github.io/aws-bedrock-agentcore-strands/protocol/) |
...
| The day-82 refund | **Illustrative** — a fictional airline | [The simulator](https://akash-coded.github.io/aws-bedrock-agentcore-strands/simulator/#/) |
