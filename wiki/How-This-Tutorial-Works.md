...
# How This Tutorial Works, and Why Every Lesson Looks the Same
...
is on [Sources and Confidence](Sources-and-Confidence).

## Where to start

| You are | Start at | Then |
| --- | --- | --- |
| New to agentic delivery | [What is the agentic PDLC?](What-Is-the-Agentic-PDLC) | The fundamentals, in order |
| Already delivering, and something is going wrong | [Why agentic AI projects fail](Why-Agentic-AI-Projects-Fail) | The phase your problem lives in |
| Here for one phase | [P0](P0-Frame-Is-an-AI-Agent-Worth-Building) · [P1](P1-Design-and-Spec-Write-a-Spec-an-Agent-Can-Build) · [P2](P2-Build-and-Prove-Build-an-AI-Agent-in-Slices) · [P3](P3-Run-and-Learn-Run-an-AI-Agent-in-Production) | The next phase |
...
| The seven-slot anatomy and the three origin marks | **Original** — this tutorial | [The authoring guide](https://github.com/akash-coded/aws-bedrock-agentcore-strands/blob/main/site/content/learn/README.md) |
