...
# P3 Run & Learn: How to Run an AI Agent in Production Safely
...
<p align="center"><a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/p3-run-and-learn/"><picture><source media="(prefers-color-scheme: dark)" srcset="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-shadow-widen.dark.webp"><img alt="Shadow first, then widen the live share step by step" src="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-shadow-widen.light.webp" width="100%"></picture></a></p>

<sub>▸ <a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/p3-run-and-learn/">Open the live, interactive version</a></sub>
...
P3 is the fourth phase of the [agentic PDLC](What-Is-the-Agentic-PDLC), and the one that
...
<p align="center"><a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/p3-run-and-learn/"><picture><source media="(prefers-color-scheme: dark)" srcset="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-two-numbers.dark.webp"><img alt="The two numbers a sponsor reports together: the saving and the spend" src="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-two-numbers.light.webp" width="100%"></picture></a></p>
...
<p align="center"><a href="https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/p3-run-and-learn/"><picture><source media="(prefers-color-scheme: dark)" srcset="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-bill-factors.dark.webp"><img alt="Four ordinary habits multiply into a bill 4.4 times its estimate" src="https://akash-coded.github.io/aws-bedrock-agentcore-strands/assets/learn/figure-bill-factors.light.webp" width="100%"></picture></a></p>
...
P0. [The eight loops](The-8-Feedback-Loops-of-Agentic-Delivery) are how that learning finds its way back.
...
| Idea | Origin | Source |
| --- | --- | --- |
| Shadow, 5%, widen on evidence; the two drift thresholds; the two-number report | **Original** — this playbook | [QA lead](https://akash-coded.github.io/aws-bedrock-agentcore-strands/qa/#watch) · [Gates and Governance](Gates-and-Governance#paired-indicators-and-the-two-number-report) |
...
| The SkyWays figures | **Illustrative** — a fictional airline | [Try the cut-over calculator](https://akash-coded.github.io/aws-bedrock-agentcore-strands/simulator/#/toolkit/cutover) |

---

| | |
| :--- | ---: |
| [← P2 · Build & Prove](P2-Build-and-Prove-Build-an-AI-Agent-in-Slices) | [The eight loops →](The-8-Feedback-Loops-of-Agentic-Delivery) |

**[All lessons](Start-Here)** · **[Agentic PDLC fundamentals](Tutorial-Fundamentals)** · [This lesson on the site](https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/p3-run-and-learn/)

<sub>✏️ This page is generated from [`site/content/learn/lessons/p3-run-and-learn.md`](https://github.com/akash-coded/aws-bedrock-agentcore-strands/blob/main/site/content/learn/lessons/p3-run-and-learn.md). To change it, [edit the lesson](https://github.com/akash-coded/aws-bedrock-agentcore-strands/edit/main/site/content/learn/lessons/p3-run-and-learn.md) — an edit made here is replaced at the next sync.</sub>
