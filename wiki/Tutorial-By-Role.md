...
| 4 | **[The Agentic PDLC for Software Engineers: Building With Agents](Agentic-PDLC-for-Software-Engineers)** | How software engineers work in the agentic PDLC: a context file, story files, exact code first, gated tools, a harness that decides merges, and a bolt a day. | 6 min |
| 5 | **[AI-DLC and AIDD for Forward-Deployed Engineers: A Field Guide](AI-DLC-and-AIDD-for-Forward-Deployed-Engineers)** | How a forward-deployed engineer runs AI-DLC and AIDD at a customer: measure their pain, have their risk owner sign the limits, build in their stack, hand over. | 7 min |
| 6 | **[The Agentic PDLC for QA: How to Test Probabilistic Software](Agentic-PDLC-for-QA-Testing-Probabilistic-Software)** | How QA works in the agentic PDLC: the proof each kind of step owes, golden sets by slice, lower bounds instead of scores, injection suites, shadow runs and drift. | 6 min |
