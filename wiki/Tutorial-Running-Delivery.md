...
| 7 | **[Is 82% Good Enough? How to Prove an AI Agent Meets Its Bar](How-to-Prove-an-AI-Agent-Meets-Its-Bar)** | A score from a test set is an estimate with a width. How to report the lower bound, count the cases a slice still owes, and give a verdict a sceptic will accept. | 6 min |
