...
*Two of the things this workload needs bill for existing, the model version is part of the environment, and the prompt is a deployable artefact.*

**5 min read** · Intermediate · Lesson 7 of 9 in [By role](Tutorial-By-Role) · Updated 23 Sep 2026 · [Read it on the site, with live diagrams ↗](https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/agentic-pdlc-for-devops/)
