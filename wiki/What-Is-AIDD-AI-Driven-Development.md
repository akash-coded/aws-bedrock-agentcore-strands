...
# What Is AI-Driven Development (AIDD)? The Daily Craft
...
**7 min read** · Beginner · Lesson 3 of 7 in [Methods decoded](Tutorial-Methods-Decoded) · Updated 24 Sep 2026 · [Read it on the site, with live diagrams ↗](https://akash-coded.github.io/aws-bedrock-agentcore-strands/learn/what-is-aidd/)
...
in P2, [Build & Prove](P2-Build-and-Prove-Build-an-AI-Agent-in-Slices).
...
[Code review for AI-generated code](How-to-Review-by-Risk-Band).
...
| Idea | Origin | Source |
| --- | --- | --- |
| Context files: CLAUDE.md, AGENTS.md, Copilot instructions, Cursor rules | **Borrowed** — documented, September 2026 | Anthropic, OpenAI, GitHub and Cursor documentation; see [Sources and Confidence](Sources-and-Confidence) |
| The five habits, the story file and the exact floor | **Original** — this playbook | [Engineering lead](https://akash-coded.github.io/aws-bedrock-agentcore-strands/engineering/) |
...
| The SkyWays examples | **Illustrative** — a fictional airline | [The simulator](https://akash-coded.github.io/aws-bedrock-agentcore-strands/simulator/#/) |
