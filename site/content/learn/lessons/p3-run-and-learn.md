...
answers whether the system is up and fast; it was never looking for this. Watch the **output mix** —
the share of each kind of decision — because accuracy needs labels and arrives late, while the mix is
