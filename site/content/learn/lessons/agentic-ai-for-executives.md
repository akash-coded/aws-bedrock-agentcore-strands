---
title: Agentic AI for Executives: Four Decisions Only You Can Make
...
- the four agentic AI decisions that belong to leadership, and what to ask for each;
- the four questions that keep them true, and the maturity check that replaces tool counts;
- seven signals worth escalating, and a first thirty days that needs no budget approval.

## Sound familiar?

- The organisation has an agent-first directive and a portfolio of pilots, and none has reached production.
- The board pack shows one accuracy number and a count of AI tools adopted.
- The largest AI cost line arrived as a surprise, from finance.

None of these is a delivery failure. Each is a leadership decision being made by default, somewhere
below the level that should be making it.

## The four decisions, step by step
...
| Ask | Of what | A good answer |
| --- | --- | --- |
| Which of these are rules? | The roadmap | Two or three of the top five, on record |
| What may it do without a person, and who decided? | Each action | Someone opens a tool's signature when you ask to see the cap |
...
A single accuracy number in a board pack · a cap that lives in a prompt · a launch date agreed before a
shadow run · tool adoption reported as maturity · a postmortem that produced a name · a cost number that
arrived from finance · a dashboard that stopped moving while work continues. None is a failure; each is a
...
Gartner expects over 40% of agentic AI projects to be cancelled by the end of 2027, for escalating costs,
unclear business value or inadequate risk controls. All three are leadership decisions left to default:
what counts as value, what the agent may do, and what counts as evidence.

## Try it

Your CTO proposes an "AI-first" target: 50% of new features to include an AI agent by year end. **Which of
the four decisions does this pre-empt, and what would you ask for instead?**
...
1. **Four decisions are yours**: what is AI work, what agents may do alone, what counts as evidence, what gets funded.
2. **Four questions, every cycle**, and a maturity count of six controls instead of tools adopted.
3. **Thirty days, no budget**: ask the questions, see one cap, take a baseline, name the governance owner.

## FAQ

### What should executives know about agentic AI?
...
By controls, not tools: a context file the agents read, a spec with a bar and an owner for every item, a
harness that blocks merges per slice, caps in tool signatures, a trace that redacts, and production
evidence with drift watched. The level is how many of the six a team can show.

### Should we mandate that teams use AI agents?
