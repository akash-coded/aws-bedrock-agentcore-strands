...
def _operating_model() -> str:
    roles = [
        ("Product manager", "product-manager", "#3E6B8A",
        ...
        ("Solution architect", "solution-architect", "#7A6A46",
        ...
        ("Engineering lead", "engineering", "#2F6B57",
        ...
        ("DevOps and platform", "devops", "#6B4E8A",
